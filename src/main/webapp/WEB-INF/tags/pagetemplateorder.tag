...
<div class="container mt-4" style="min-height: 400px;">
    ...
    <c:choose>
        ...
        <c:when test = "${sessionScope.step == 1}">
            <div id="step1"><a class="active" href="order1.jsp?step=1">Definer mål</a></div>
            <div id="step2"><a href="order2.jsp?step=2">Ekstra tilføjelser</a></div>
        ...
        <c:when test = "${sessionScope.step == 2}">
            ...
            <div id="step2"><a class="active" href="order2.jsp">Ekstra tilføjelser</a></div>
